...
func TestNewUserRepository(DB *sql.DB, allRepos *map[string]interface{}) *UserRepository {
	return &UserRepository{DB, allRepos}
}

// AddUser takes in a user.User struct and persists it in the database.
func (repo *UserRepository) TestAddUser(u *user.User) error {
	var err error
...
func (repo *UserRepository) TestGetUser(username string) (*user.User, error) {
	var err error
	var u = new(user.User)
...
func (repo *UserRepository) TestgetBio(username string) (string, error) {
	var bio string
...
// getBookmarkedPosts is just a helper function
func (repo *UserRepository) TestgetBookmarkedPosts(username string) (map[int]time.Time, error) {
...
func (repo *UserRepository) TestUpdateUser(username string, u *user.User) error {
	var err error
...
func (repo *UserRepository) TestexecUpdateStatementOnColumn(column, value, username string) error {
...
func (repo *UserRepository) TestDeleteUser(username string) error {
	// TODO
...
func (repo *UserRepository) TestSearchUser(pattern, sortBy, sortOrder string, limit, offset int) ([]*user.User, error) {
...
func (repo *UserRepository) TestPassHashIsCorrect(username, passHash string) bool {
	var temp string
...
func (repo *UserRepository) TestBookmarkPost(username string, postID int) error {
...
func (repo *UserRepository) TestDeleteBookmark(username string, postID int) error {
...
func (repo *UserRepository) TestUsernameOccupied(username string) (bool, error) {
	var occupied bool
...
func (repo *UserRepository) TestEmailOccupied(email string) (bool, error) {
	var occupied bool
